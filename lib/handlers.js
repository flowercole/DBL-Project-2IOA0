...
handlers.upload = (data, callback) => {
    if(data.method == 'get'){
        helpers.getView('upload', (err, str) => {
            if(!err && str){
                callback(200, str, 'html');
            } else {
                callback(500, undefined, 'html');
...
handlers.visualization = (data, callback) => {
    if(data.method == 'get'){
        helpers.getView('visualization', (err, str)=> {
            if(!err && str){
                callback(200, str, 'html');
            } else {
                callback(500,'undefined', 'html');
...
handlers.testing = (data, callback) => {
    if(data.method == 'get'){
        helpers.getView('testing', (err, str)=> {
            if(!err && str){
                callback(200, str, 'html');
            } else {
                callback(500,'undefined', 'html');
